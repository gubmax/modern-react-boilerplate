...
import { PATH_RESOLVED_CLIENT, PATH_RESOLVED_DIST_SERVER } from 'shared/constants/paths'
...
export const CONFIG_ENTRIES: Record<string, Entry> = {
  [HtmlEntries.MAIN]: {
    // Production
    entryPath: `${PATH_RESOLVED_DIST_SERVER}/${HtmlEntries.MAIN}.js`,
  ...
  [HtmlEntries.INTERNAL_ERROR]: {
    // Production
    entryPath: `${PATH_RESOLVED_DIST_SERVER}/${HtmlEntries.INTERNAL_ERROR}.js`,
